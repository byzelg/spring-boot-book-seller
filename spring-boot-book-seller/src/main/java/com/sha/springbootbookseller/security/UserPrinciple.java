...
public class UserPrinciple implements UserDetails
{
    ...
    transient private String password;  //transient:parolayi gecici ayarlamayi saglar
    transient private User user;    //User nesnesi oturum acma isleminde kullanilacak. Amac; databasede useri birden fazla kez cagirmamak
